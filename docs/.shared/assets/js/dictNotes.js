...
export const noteHTML = {
  ...
  <ul class="ms-0 ps-3 mb-0">
    <li><b>Cliente</b><br>
    Pessoa, empresa ou organização que adquire ou contrata um produto, sistema ou serviço. É quem define os requisitos, financia o desenvolvimento e detém os direitos contratuais sobre o que está sendo entregue.
    <br>Nem sempre o cliente é quem vai utilizar diretamente o sistema; sua visão pode ser mais estratégica ou gerencial. Por isso, entender claramente as necessidades do cliente é essencial, mas também é necessário alinhar essas necessidades com a realidade de quem vai operar o sistema no dia a dia.</li>
    <li class="mt-1"><b>Usuário (final)</b><br>
    Pessoa que utiliza diretamente o produto ou sistema em seu dia a dia. Responsável por operar as funcionalidades oferecidas e interagir com a interface, sendo o principal afetado pela usabilidade, eficiência e eficácia do sistema.
    <br>Deve ser o foco das decisões de design de interface, acessibilidade e experiência de uso. Muitas vezes, há uma diferença entre o que o cliente deseja e o que o usuário final realmente precisa. Por isso, é comum que projetos bem-sucedidos envolvam testes com usuários reais, entrevistas e coleta de feedback ao longo do desenvolvimento.</li>
  </ul>
  </div>
  <div style="font-size: 0.65rem;"><p class="mt-0 mb-0">Fonte: ChatGPT</p></div></div>`,
  ...
  <ul class="ms-0 ps-3 mb-0">
    ...
    <li><b>SUBSAN</b> Subsecretaria de Segurança Alimentar e Nutricional </li>
