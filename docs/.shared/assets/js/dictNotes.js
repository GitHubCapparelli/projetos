...
export const noteHTML = {
  ...
  <p class="mb-1">Define os requisitos, financia o desenvolvimento e detém os direitos contratuais sobre o que está sendo entregue.</p>
  <p class="mb-1">Nem sempre é quem utiliza diretamente o sistema; sua visão pode ser mais estratégica ou gerencial.</p>
  ...
  <p class="mb-1">Opera as funcionalidades oferecidas e interage com a interface, sendo o principal afetado pela usabilidade, eficiência e eficácia do sistema.</p>
  <p class="mb-1">Foco das decisões de design de interface, acessibilidade e experiência de uso.</p>
  <p class="mb-1">Muitas vezes, há uma diferença entre o que o cliente deseja e o que o usuário final realmente precisa. Por isso, projetos bem-sucedidos envolvem testes com usuários reais, entrevistas e coleta de feedback ao longo do desenvolvimento.</li>
  </ul>
  </div>
